<?
if($_POST['name']){ // массив значение полей
  $znach = array(
    1 => $_POST['name'],
    2 => $_POST['kod'],
    3 => $_POST['tel'],
  ...
  mail("Onatskaya.Nadejda@gmail.com", "Заказ звонка".$_SERVER['HTTP_REFERER'],  
  $znach[1]." ". 
  $znach[2]." ".
  $znach[3]." ".
  $znach[4]." ".
...
Header("Refresh: 3; URL=".$_SERVER['HTTP_REFERER']); // спустя 3 сек. возвращаемся на предыдущий URL
?>
...
Мы позвоним Вам в течении 15 минут</div>
</div>

<script> //  label на пред. страницу
